        ...
        <div>
          ...
          <FadeIn delay={0.6}>
            <p className="text-grey-400 text-lg md:text-xl max-w-2xl mb-12 leading-relaxed">
              Specialized in building performant, type-safe web applications
              with modern frontend technologies. Focused on clean architecture,
          ...
          <FadeIn delay={0.8}>
            <div className="flex flex-col sm:flex-row gap-4">
              <MagneticButton>
                <a
                  href="#projects"
                  className="group inline-flex items-center justify-center gap-3 bg-grey-900 text-grey-0 px-8 py-4 hover:bg-accent-500 hover:text-white transition-all duration-300"
                >
              ...
              <MagneticButton>
                <a
                  href="#contact"
                  className="group inline-flex items-center justify-center gap-3 border border-grey-100 text-grey-900 px-8 py-4 hover:border-accent-500 hover:text-accent-500 transition-all duration-300"
                >
